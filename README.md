...
```diff
+ Learning Angular. Signals, DI, the whole deal.
+ Vue 3 is still home turf, but scouting the other side of the SPA fence.
```
...
![Angular](https://img.shields.io/badge/Angular-LEVELING%20UP-F59E0B?style=flat-square&logo=angular&logoColor=white)
...
- Computer graphics: rendering pipelines, ray tracing, the kind of math nobody brings up at parties.
- Video games: professional deformation at this point. Started as a player, now can't stop wondering how the sausage gets made.

## 🏆 Achievements Unlocked

```
[✓] Built a lead-dedup pipeline handling ~600 req/min (peaks ~2000), pushed merge accuracy from ~70% to ~97%
[✓] Shipped a shift-scheduling platform with a time tracker embedded straight into a third-party CRM UI
[✓] Co-maintain marketplace apps with 100,000+ combined installs
[✓] Running my own coding school for kids since 2021 — architecture, code, and the invoices
[ ] Make Angular feel as natural as Vue
```

## 💾 Save File

[![Email](https://img.shields.io/badge/email-artyom%40nesin.dev-7C3AED?style=flat-square)](mailto:artyom@nesin.dev)
